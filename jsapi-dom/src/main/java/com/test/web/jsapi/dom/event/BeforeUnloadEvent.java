...
public final class BeforeUnloadEvent<ELEMENT> extends Event<ELEMENT> {

    public BeforeUnloadEvent(Element<ELEMENT, ?, ?, ?> target, HTMLEvent htmlEvent, long timeStamp,
            boolean composed, boolean isTrusted) {
